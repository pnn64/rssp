...
pub fn analyze_crs_path(
    ...
    analyze_crs_path_impl::<true, true, true, true>(
        course_path,
        songs_dir,
        target_step_type,
        course_difficulty,
...
pub fn profile_analyze_crs(
    ...
    if song_key_cache {
        analyze_crs_path_impl::<true, false, false, false>(
            course_path,
            songs_dir,
            target_step_type,
            course_difficulty,
        ...
        analyze_crs_path_impl::<false, false, false, false>(
            course_path,
            songs_dir,
            target_step_type,
            course_difficulty,
...
pub fn profile_analyze_groups(
    ...
    if group_cache {
        analyze_crs_path_impl::<true, true, false, false>(
            course_path,
            songs_dir,
            target_step_type,
            course_difficulty,
...
pub fn profile_analyze_catalog(
    ...
    if group_catalog {
        analyze_crs_path_impl::<true, true, true, false>(
            course_path,
            songs_dir,
            target_step_type,
            course_difficulty,
...
"#,
    ...
    fn course_analysis_caches_songs_and_deduplicates_hashes() {
        ...
        let path_cached = analyze_crs_path_impl::<false, false, false, false>(
            &course_path,
            Some(&songs_dir),
            "dance-single",
            "Medium",
        ...
        let group_uncached = analyze_crs_path_impl::<true, false, false, false>(
            &course_path,
            Some(&songs_dir),
            "dance-single",
            "Medium",
        ...
        let catalog_checked = analyze_crs_path_impl::<true, true, true, false>(
            &course_path,
            Some(&songs_dir),
            "dance-single",
            "Medium",
