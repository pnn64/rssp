    ...
    for ((step_type, difficulty), expected_entries) in golden_entries {
        ...
        for idx in 0..count {
            ...
            println!(
                ...
                expected_min.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                actual_min.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                expected_max.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                actual_max.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                expected_display.unwrap_or("-"),
                actual_display.unwrap_or("-"),
                expected_display_min.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                actual_display_min.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                expected_display_max.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                actual_display_max.map_or_else(|| "-".to_string(), |v| format!("{v:.3}")),
                status
            );
        }
